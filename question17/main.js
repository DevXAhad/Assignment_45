...
while (guestList.length > 2) {
    var removedGuest = guestList.pop(); //removes guests until two guests are left in the array
    console.log("Sorry! We apologise Mr/Mrs ".concat(removedGuest, ", you are not invited."));
}
for (var i = 0; i < guestList.length; i++) {
