...
let animals: string [] = ['Elephant', 'Giraffe', 'Lion'];
for(let animal of animals){
    console.log(`A(n) ${animal} is really satisfying to look at.`)
}
console.log(`All of these animals have a common characteristic and that is: They reproduce, have a tail, eyes and are carnivore by nature.`)