...
// Question 2,storing a person's name in a variable:
// let personName: string = 'Abdul Ahad'
// console.log(`Hello ${personName} would you like to learn some python today?`)
//Question 3, Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
/* let personName: string = 'Abdul Ahad';
function toTitleCase(str: string): string {
      return str.replace(/\w\S*(add here: g, function (txt))// { //this is regular expression,\w\S* matches words in the string.\w: Matches any word character (alphanumeric plus underscore).\S*: Matches zero or more non-whitespace characters.The g flag at the end ensures that this replacement is done globally throughout the string.
...
/* let personName: string = "Warren Buffet";
console.log(`${personName} once said, "You can't make a good deal with a bad person!" `)*/
...
/* let famous_person: string = "Warren Buffet";
let message: string = "You can't make a good deal with a bad person";
