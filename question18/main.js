...
var favDestination = ['Germany', 'Switzerland', 'Norway', 'Denmark', 'Sweden'];
// Print your array in its original order.
console.log("Original Array:", favDestination);
// Print your array in alphabetical order without modifying the actual list.
var sortedArray = __spreadArray([], favDestination, true).sort(); // three dots create a copy of the original array
console.log("Sorted Array:", sortedArray);
//  Show that your array is still in its original order by printing it.
console.log("Original Array:", favDestination);
// Print your array in reverse alphabetical order without changing the order of the original list.
console.log('In Reverse Alphabetical ', __spreadArray([], favDestination, true).sort().reverse());
